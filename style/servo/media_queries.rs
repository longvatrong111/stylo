...
impl Device {
    ...
    pub(crate) fn system_color(
        ...
        let system_color = match system_color {
            // Deprecated system colors map to the modern set.
            ...
            SystemColor::Threedlightshadow => SystemColor::Buttonface,
        ...
        if dark {
            match system_color {
                ...
                SystemColor::Buttonborder => srgb(255, 255, 255),
                SystemColor::Buttonface => srgb(107, 107, 107),
                SystemColor::Buttontext => srgb(245, 245, 245),
                SystemColor::Canvas => srgb(30, 30, 30),
                SystemColor::Canvastext => srgb(232, 232, 232),
                SystemColor::Field => srgb(45, 45, 45),
                SystemColor::Fieldtext => srgb(240, 240, 240),
                SystemColor::Graytext => srgb(155, 155, 155),
                ...
                _ => unreachable!("Deprecated system colors should have been mapped"),
            }
        } else {
            match system_color {
                ...
                SystemColor::Buttonborder => srgb(0, 0, 0),
                SystemColor::Buttonface => srgb(240, 240, 240),
                SystemColor::Buttontext => srgb(0, 0, 0),
                SystemColor::Canvas => srgb(255, 255, 255),
                SystemColor::Canvastext => srgb(0, 0, 0),
                SystemColor::Field => srgb(255, 255, 255),
                SystemColor::Fieldtext => srgb(0, 0, 0),
                SystemColor::Graytext => srgb(109, 109, 109),
